...
This module adds a wizard to update prices of the products of an invoice according to the price list is chosen in the wizard.(Only Update if the price in the product isn't zero)
